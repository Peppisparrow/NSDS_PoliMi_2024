...
public class StreamingWordCountWithState {
    public static void main(String[] args) {
        ...
        //map with state e una funzione che prende 3 parametri state e il precedente stato quindi il precedente count
        //questo metodo ci permette di non avere finestre e quindi continuare a computare i dati legandoli ai precedenti
